...
module.exports = {
 ...
 category: 'ai',
 guide: {
 vi: ' {pn} [on | off]: bật/tắt hinu ♡'
 + '\'\n'
 + '\ {pn} <word>: chat nhanh với hinu ♡'
 + '\ Ví dụ:\ {pn} hi',
 en: ' {pn} <word>: chat with hinu ♡'
 + '\ Example:\ {pn} hi'
 }
 },
 langs: {
 ...
 chatting: 'Already Chatting with hinu ☢️...',
 error: 'error cannot to my boss ayan Chowdhury'
 }
 },
